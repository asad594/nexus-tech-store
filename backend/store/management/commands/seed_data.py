    ...
    def handle(self, *args, **options):
        ...
        products_data = [
            ...
            },
            {
                ...
                'price': 479.00,
                'brand': 'Apple',
                'description': 'Apple-designed dynamic driver provides high-fidelity audio. Active Noise Cancellation with Transparency mode, computational audio powered by Apple H1 chip in each ear cup, and breathable mesh canopy headband.',
                'specs': {'chip': 'Dual Apple H1 Chips', 'battery': '20 Hours Playtime with ANC', 'anc': 'Active Noise Cancellation & Transparency Mode', 'audio': 'Personalized Spatial Audio'},
                'stock_qty': 15,
                'image_url': '/images/products/airpods/airpods-max-1.png',
                'is_featured': True,
                'is_new': False,
                'rating': 4.9,
            },
            ...
            {
                'name': 'Quantum Thunderbolt 4 Glass Dock',
                'category': cat_objs['accessories'],
                'price': 299.00,
                'brand': 'NEXUS',
                'description': '12-in-1 translucent tempered glass docking station with dual 8K display support and 100W GaN power delivery.',
                'specs': {'ports': '12 Ports (Thunderbolt 4, HDMI 2.1, 10GbE)', 'power': '100W Pass-through GaN', 'display': 'Dual 8K @ 60Hz', 'body': 'Frosted Gorilla Glass'},
                'stock_qty': 18,
                'image_url': 'https://images.unsplash.com/photo-1544652478-6653e09f18a2?q=80&w=1000&auto=format&fit=crop',
                'is_featured': True,
                'is_new': True,
                'rating': 4.9,
            },
            {
                'name': 'Nexus MagCharge Studio Pad',
                'category': cat_objs['accessories'],
                'price': 129.00,
                'brand': 'NEXUS',
                'description': '3-in-1 magnetic wireless fast charging station for smartphone, smart watch, and acoustics with ambient mood lighting.',
                'specs': {'charging': '15W Fast Wireless', 'compatibility': 'Qi2 & MagSafe Standard', 'material': 'Anodized Aluminum & Leather', 'lighting': 'RGB Halo Ring'},
                'stock_qty': 30,
                'image_url': 'https://images.unsplash.com/photo-1622445268121-ac11932811fe?q=80&w=1000&auto=format&fit=crop',
                'is_featured': False,
                'is_new': True,
                'rating': 4.7,
            },
            {
                'name': 'CyberPen Precision Stylus Pro',
                'category': cat_objs['accessories'],
                'price': 149.00,
                'brand': 'NEXUS',
                'description': 'Zero-latency active stylus with 8192 pressure levels, tilt detection, magnetic inductive charging, and haptic feedback.',
                'specs': {'latency': '1.2ms Low Latency', 'pressure': '8192 Pressure Levels', 'battery': '14 Hours Active Use', 'charging': 'Magnetic Snap Charge'},
                'stock_qty': 25,
                'image_url': 'https://images.unsplash.com/photo-1585336261026-61e778129d42?q=80&w=1000&auto=format&fit=crop',
                'is_featured': False,
                'is_new': False,
                'rating': 4.8,
            },
            {
                'name': 'Nexus Mechanical Cyber Keyboard',
                'category': cat_objs['accessories'],
                'price': 219.00,
                'brand': 'NEXUS',
                'description': 'Hot-swappable magnetic hall-effect key switch keyboard with translucent frosted acrylic body and per-key RGB backlighting.',
                'specs': {'switches': 'Magnetic Hall-Effect Switches', 'connectivity': 'Tri-Mode (2.4G, BT 5.3, USB-C)', 'actuation': '0.1mm - 4.0mm Rapid Trigger', 'battery': '4000mAh RGB'},
                'stock_qty': 15,
                'image_url': 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?q=80&w=1000&auto=format&fit=crop',
                'is_featured': True,
                'is_new': True,
                'rating': 4.9,
            },
